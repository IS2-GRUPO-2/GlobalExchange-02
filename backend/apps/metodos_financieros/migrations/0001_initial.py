...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(choices=[('TRANSFERENCIA_BANCARIA', 'Transferencia Bancaria'), ('BILLETERA_DIGITAL', 'Billetera Digital'), ('TARJETA', 'Tarjeta de Crédito/Débito'), ('EFECTIVO', 'Efectivo'), ('CHEQUE', 'Cheque'), ('STRIPE', 'Stripe')], max_length=50, unique=True)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['cliente', 'is_active'], name='metodos_fin_cliente_23e3d1_idx'),
        ),
        migrations.AddIndex(
            model_name='metodofinancierodetalle',
            index=models.Index(fields=['es_cuenta_casa', 'is_active'], name='metodos_fin_es_cuen_d2e6c2_idx'),
        ),
