...
class Transaccion(models.Model):
    ...
    id_user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='transacciones_operadas')
    cliente = models.ForeignKey(
        Cliente, on_delete=models.CASCADE, related_name='transacciones')
    ...
    divisa_destino = models.ForeignKey(
        Divisa, on_delete=models.CASCADE, related_name='transacciones_destino')
    ...
    metodo_financiero = models.ForeignKey(
        MetodoFinanciero, on_delete=models.SET_NULL, null=True, blank=True)
    metodo_financiero_detalle = models.ForeignKey(
        MetodoFinancieroDetalle, on_delete=models.SET_NULL, null=True, blank=True)
    fecha_inicio = models.DateTimeField(auto_now_add=True)
    fecha_fin = models.DateTimeField(null=True, blank=True)
    factura_emitida = models.BooleanField(default=False)
    tauser = models.ForeignKey(
        Tauser, on_delete=models.CASCADE, related_name='transacciones')
